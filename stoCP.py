...
from dataset.synthetic import build_dataloaders
...
def default_cfg() -> Dict[str, Dict[str, Any]]:
    return {
        ...
        "dataset": {
            ...
            "n_nonsensitive": 6, "batch_size": 128, "dataset_mode": "syn",
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--methods", type=str, default='sgcp', help="'sgcp', 'baseline'")
    ...
    parser.add_argument("--dataset-mode", type=str, default=None,
                        choices=["syn", "mimic", "adult", "nursery", "bach"])
...
def config_from_args(args: argparse.Namespace) -> Dict[str, Dict[str, Any]]:
    ...
    cfg["experiment"].update({
            ...
            "run_afcp": getattr(args, "run_afcp", False),
        })
...
def build_dataset_and_loaders(data_cfg: Dict[str, Any], model_cfg: Dict[str, Any], seed: int):
    ...
    if data_cfg["dataset_mode"] == "bach":
        ...
        train_loader, cal_loader, test_loader = build_dataloaders(syn_cfg)
